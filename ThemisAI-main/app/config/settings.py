...
class Settings(BaseSettings):
    ...
    LLAMA_CPP_PATH: str = "/app/llama.cpp/build/bin/llama-cli"
    MODEL_PATH: str = "/models/tinyllama-1.1b-chat-v1.0.Q4_K_M.gguf"

    # A variável de índice foi adicionada
    OPENSEARCH_INDEX: str = "themis-index"  # Valor padrão do índice OpenSearch
