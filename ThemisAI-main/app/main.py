...
# CORREÇÃO 1: Importando o roteador de análise
...
app = FastAPI(
    title="ThemisAI Security API", # Trocando o título para o projeto real (ThemisAI)
    version="0.1.0",
...
# CORREÇÃO 2: Incluindo o roteador de análise COM O PREFIXO para que a rota seja /analysis/app-analysis
